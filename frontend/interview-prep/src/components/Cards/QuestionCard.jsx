                ...
                <div className='flex items-start justify-between cursor-pointer'>
                    ...
                    <div className='flex items-center justify-end ml-4 relative'>
                        ...
                        >
                            <button className='flex items-center gap-2 text-xs text-indigo-800 font-medium bg-indigo-50 px-3 py-1 mr-2 rounded text-nowrap border border-indigo-50 hover:border-indigo-200 cursor-pointer'
                                ...
                                {isPinned ? (
                                    <>
                                        ...
                                        <span className='hidden md:inline'>Unpin</span>
                                    </>
                                ) : (
                                    <>
                            ...
                            <button className='flex items-center gap-2 text-xs text-cyan-800 font-medium bg-cyan-50 px-3 py-1 mr-2 rounded text-nowrap border-cyan-50 hover:border-cyan-200 cursor-pointer '
                                onClick={() => {
                                    setIsExpanded(true); onLearnMore()
                                }}>
                                <LuSparkles />
                        ...
                        <button className='text-gray-400 hover:text-gray-500 cursor-pointer'
                            ...
                            <LuChevronDown
                                size={20}
                                className={`transform transition-transform duration-300 ${isExpanded ? "router-180" : ""}`}
                            />
                        </button>
                    </div>
                </div>
